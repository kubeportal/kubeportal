...
urlpatterns = [
    ...
    path('classic/', RedirectView.as_view(query_string=True, url='/accounts/login/'), name='index'),
    ...
    path('api/<str:version>/pods/<str:puid>/logs/', api_views.PodLogsView.as_view(), name='pod_logs'),
    ...
    path('api/<str:version>/storageclasses/', api_views.StorageClassesView.as_view(), name='storageclasses'),
    ...
    path('api/<str:version>/login_google/', api_views.login_google.GoogleLoginView.as_view(), name='api_google_login'),
