...
/code/manage.py createsuperuser --username $KUBEPORTAL_API_USER_USERNAME --email $KUBEPORTAL_API_USER_EMAIL --noinput --configuration=Production
/code/manage.py drf_create_token $KUBEPORTAL_API_USER_USERNAME --configuration=Production
